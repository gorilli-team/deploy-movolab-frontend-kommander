...
import ActivitiesTable from '../../../../components/Vehicles/Vehicles/Activities/ActivitiesTable';
      ...
      <div className="p-4 left-0">
        ...
        <div className="p-2">
          <div className="text-xl">
            <span className="font-semibold">Attività:</span>{' '}
            {vehicle?.plate ? vehicle.plate.toUpperCase() : ''}
          </div>
          <div className="mt-4">
            <ActivitiesTable vehicle={params.id} />
          </div>
        </div>
      </div>
    </Page>
