    ...
    const chooseVehicleMessage = async (e) => {
      ...
      if (vehicles.length > 0) {
        try {
          ...
          let messageContent = `${responseText}<br /><div class="mt-2"><a href="http://localhost:5000/dashboard/prenotazioni/${reservationId}" rel="noopener noreferrer" class="inline-block px-4 py-2 border border-blue-500 text-blue-500 bg-white rounded-md text-center hover:bg-blue-500 hover:text-white transition-colors">Vedi la tua prenotazione</a></div>`;
